...
Next, you place the repository in `<zrnt root>/tests/spec/sila.0-spec-tests`, or, symlink to them (your paths may vary):
```bash
ln -s ../../../sila.0-specs/sila.0-spec-tests tests/spec/sila.0-spec-tests
```

# ZRNT [![Go Report Card](https://goreportcard.com/badge/github.com/sila-chain/zrnt?no-cache)](https://goreportcard.com/report/github.com/sila-chain/zrnt) [![CircleCI Build Status](https://circleci.com/gh/protolambda/zrnt.svg?style=shield)](https://circleci.com/gh/protolambda/zrnt) [![MIT Licensed](https://img.shields.io/badge/license-MIT-blue.svg)](./LICENSE)
...
- `Spec`, the standard sila configuration, parametrizes a lot of the beacon functionality.
...
The `FullChain` interfaces combines the two into a usable sila chain, where blocks and attestations can be added to, and the canonical chain can be determined and navigated.
...
Hashing, merkleization, and other utils can be found in `sila/util`.
...
This package implements message validation for the Sila gossip topics, and requires the chain and blocks DB interfaces to operate.

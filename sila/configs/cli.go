...
type SpecOptions struct {
	LegacyConfig        string `ask:"--legacy-config" help:"Sila legacy configuration (combined config and presets), name or path to YAML"`
	LegacyConfigChanged bool   `changed:"legacy-config"`

	Config          string `ask:"--config" help:"Sila spec configuration, name or path to YAML"`
	Phase0Preset    string `ask:"--preset-phase0" help:"Sila phase0 spec preset, name or path to YAML"`
	AltairPreset    string `ask:"--preset-altair" help:"Sila altair spec preset, name or path to YAML"`
	BellatrixPreset string `ask:"--preset-bellatrix" help:"Sila bellatrix spec preset, name or path to YAML"`
	CapellaPreset   string `ask:"--preset-capella" help:"Sila capella spec preset, name or path to YAML"`
	DenebPreset     string `ask:"--preset-deneb" help:"Sila deneb spec preset, name or path to YAML"`
	ElectraPreset   string `ask:"--preset-electra" help:"Sila electra spec preset, name or path to YAML"`
